...
const tarot = [
    {
        ...
        arcana: "Major Arcana",
        suit: "Trump",
        img: "../images/cards/m00.jpg",
        companion_cards: ["all Major Arcana"],
        meaning: "The Fool is a card of new beginnings, opportunity and potential. Just like the young man, you are at the outset of your journey, standing at the cliff‘s edge, and about to take your first step into the unknown. Even though you don’t know exactly where you are going, you are being called to commit yourself and follow your heart, no matter how crazy this leap of faith might seem to you. Now is a time when you need to trust where the Universe is taking you./n As you undertake this new journey, the Fool encourages you to have an open, curious mind and a sense of excitement. Throw caution to the wind and be ready to embrace the unknown, leaving behind any fear, worry or anxiety about what may or may not happen. This is about new experiences, personal growth, development, and adventure./n The time is NOW! Take that leap of faith, even if you do not feel 100% ready or equipped for what is coming (who knows what it could be?!). Seriously, what are you waiting for? Do you think you need to have everything mapped out before you can begin? No way! Not with the Fool. He ventures out on his journey with just his essential belongings – and now he invites you to do the same. You don’t need to wait for someone to give you the green light or hold off until you have all the skills, tools and resources you think you might need. You are ready! If you’ve been watching for a sign, this is it!/n This is a time of great potential and opportunity for you right now. The world is your oyster, and anything can happen. Use your creative mind with a dash of spontaneity to make the most of this magical time and bring forth your new ideas in powerful ways./n The Fool is your invitation to relax, play, and have fun. Treat life like one big experiment and feel yourself in the flow of whatever comes your way. This card asks you to embrace your beautiful, carefree spirit, allowing yourself to connect to the energy that surrounds you and flows through you. Tap into your fullest potential by stepping into a place of wonderment, curiosity and intrigue. Live life as though you were a child once again. Laugh more, dance, and let your heart go free./n This is an excellent card to meditate on if you are struggling with dread, worry or self-doubt in your life. The Fool is your guide, as someone who is daring and carefree. He is the embodiment of who you really are – your free spirit, your inner child, and your playful soul. Any time you experience fear, remember the essence of the Fool as he encourages you to acknowledge that fear and do it anyway! You never know what the future holds, but like the Fool, you must step into the unknown, trusting that the Universe will catch you and escort you along the way. Take a chance and see what happens.",
        reversed_meaning: "The Fool reversed suggests that you have conceived of a new project but aren’t ready to ‘birth’ it into the world just yet. You may worry that you are not fit or that you don’t have all the tools, skills and resources you need to make this project a success. Or perhaps you have a sense that the timing isn’t right. Something is holding you back, and you are preventing yourself from moving forward. You may choose to keep this new opportunity to yourself for now, or you might be ‘parking’ it until a better time./n You may fear the unknown, wondering, ‘What am I getting myself into?’ As a result, you have come to a standstill, worried about taking any action where you don’t know the outcome. This often boils down to the need to control everything. Balance this out with knowing that the Universe has your back and you can take this step forward, even if you are unsure of exactly what will happen next./n On the flipside, the reversed Fool can show that you are taking too many risks and acting recklessly. In your attempt to live ‘in the moment’ and be spontaneous and adventurous, you may do so in total disregard of the consequences of your actions and engaging in activities that put both yourself and others at risk. Look at the bigger picture and consider how you can keep the free spirit of the Fool without harming others./n In light of the playful and fun energy of the upright Fool, the reversal suggests you are exploring this spirit on a more personal and quiet level. For example, instead of letting down your hair and dancing up on stage, you are dancing in your bedroom like no-one is watching. Look at how you can bring more play into your daily life, even if you start out by doing it in private.",     
        keywords: ["New beginnings", "Carefree", "Optimistic", "Important decisions"],
        reversed_keywords: ["Holding back, recklessness, risk-taking"],
        upright_questions: ["What are you ready to start?", "What are you willing to risk?", "What tools are required to accomplish your goals?"],
        reversed_questions: ["What practical/obvious details are you ignoring?", "What bad decisions in the past might be setting you up for, or contributing to your failure right now?", "What does right relationship to full-hearted faith look and feel like for you?"],
        ...
        yes_no: "The Fool represents new beginnings and carefree adventure. Though this card could indicate foolishness, it is more optimistic in the sense that it stands for pure actions and being free from the constraints of your present life. More than likely, there are important decisions coming your way, and the answer to your question is yes.",
        numerology: "0",
    ...
    },
    {
        ...
        upright_questions: ["What resources do you already have access to that can help you get the job done?", "What needs to be transformed and what does it need to be transformed to?", "What project/idea/venture is still in an early phase and needs to be protected?"],
        reversed_questions: ["What abilities or talents are you ignoring that can help you accomplish your goals?", "What illusions or tricks are you buying into?", "What is your current relationship to ritual and ceremony?"],
        ...
        yes_no: "The Magician is symbolic of action and power in your life. Its positive connotations illustrate someone who is a smooth talker and good at all aspects of communication. This card suggests using your strong will power to move forward and take action. The answer to your question is yes.",
        numerology: "1",
        element: { element: "Air", description: "The Air element rules over the intellect and the balancing and opposing nature of thoughts. It is a fast-moving energy that seems invisible, but is always there. This element forces you to look at different perspectives and deal with the challenges in your life."},
        astrological_associations: "Mercury"
    },
    {
        card_name: "The High Priestess",
        arcana: "Major Arcana",
        suit: "Trump",
        img: "../images/cards/m02.jpg",
        companion_cards: ["Justice", "Judgement"],
        meaning: "The High Priestess signifies spiritual enlightenment, inner illumination, divine knowledge and wisdom. She shows up in your Tarot readings when the veil between you and the underworld is thin, and you have the opportunity to access the knowledge deep within your soul. Now is the time to be still so you can tune in to your intuition. The answers you are seeking will come from within, from your deepest truth and ‘knowing’. Allow the High Priestess to become your guide as you venture deep into your subconscious mind and access this inner wisdom. Connect with your intuition and your Higher Self through meditation, visualisation, shamanic journeying, and being part of spiritual communities./n Your intuitive sense right now is providing you with useful information and is assisting you to become more in touch with your subconscious mind. Knowledge of how to fix these issues will not come through thinking and rationalising, but by tapping into and trusting your intuition, so allow yourself the time and space to meditate and attend to your inner voice. Look for areas in your life that may be out of balance or lacking ‘flow’ and ease./n Now is also a time of heightened intuitive ability and psychic insight. If you are developing these skills, the High Priestess offers you further encouragement to continue your journey and trust that you are on the right path. The more you listen to your intuition, the more it will flow./n Finally, the High Priestess is a signal that you are being called to embrace the Divine Feminine – your connection to your intuition, compassion, empathy, and inner wisdom. Regardless of your gender, it is vital for you to balance and integrate your masculine and feminine energies, and the presence of the High Priestess signals that your sacred feminine needs your attention right now. Feel, rather than think. Collaborate, rather than compete. Create, rather than destroy. Trust your Divine Feminine energy, even if the masculine energy around you may appear to be stronger. Be proud of your ability to nurture, trust, sense, and empathise instead of hiding it away.",
        reversed_meaning: "The reversed High Priestess calls on you to be still and direct your attention inward to listen to your voice and wisdom. You may be swayed by other people’s opinions or swept up in their drama when what you really need to do is focus on what is right for you. It is time to get quiet and withdraw yourself from the external world to observe what your inner guidance is sharing with you now./n Ask yourself: Do I struggle to trust my intuition fully? Perhaps you doubt yourself or feel silly or guilty for listening to your intuition, and as a result, you deny your ability to tune in and receive this potent information. You may also keep your intuitive capabilities hidden from others, fearful of their judgements or opinions. If this resonates, know that your intuition is your superpower, here to guide you and help you. Have faith in the Universe and allow yourself to be in flow with its energies. Surrender and let go./n Think of the High Priestess as the calm centre inside of you that is untouched by your external world and trust that she is always there when you need her. Whenever you worry that things are just getting too crazy, find a quiet space and meditate so you can hear her voice. If you stop thinking or fretting about your issue and instead clear the way for your intuition to speak to you, the answer will follow./n Finally, the secretive nature of the High Priestess may suggest gossip and hidden agendas. Others may be keeping information from you or talking about you behind your back and sharing mistruths. Rather than making assumptions or diving into the depths of paranoia, have an open and honest conversation to surface and address these secrets.",
        keywords: ["Feminine influences", "Insightful", "Mystery", "Understanding", "Wisdom"],
        reversed_keywords: ["Secrets", "Disconnected from intuition", "Withdrawal and silence"],
        upright_questions: ["What is your intuition telling you?", "What new level of learning or certification are you ready to commit to?", "What is ready to be healed?"],
        reversed_questions: ["Are you acting too aloof or disconnected from your friends, family, and community?", "Are you balancing the spiritual and practical aspects of life well or not?", "Where does their need to be more fun and good humor in your life?"],
        ...
        yes_no: "The High Priestess is a spiritually intuitive woman full of mystery, wisdom, and understanding. A journey of self-discovery goes hand-in-hand with the presence of this card in your spread. She stands for things yet to be discovered in your life, and thus the answer to your question is unclear.",
        numerology: "2",
        element: { element: "Water", description: "The element of water represents emotions and relationships. It can be calm and gentle or forceful and dangerous. Like water, emotions ebb and flow and are influenced by their surroundings."},
        astrological_associations: "The Moon"
    },
    {
        card_name: "The Empress",
        arcana: "Major Arcana",
        suit: "Trump",
        img: "../images/cards/m03.jpg",
        companion_cards: ["The Hanged Man", "The World"],
        meaning: "The Empress signifies a strong connection with our femininity. Femininity translates in many ways – elegance, sensuality, fertility, creative expression, nurturing – and is necessary for creating balance in both men and women. The Empress calls on you to connect with your feminine energy. Create beauty in your life. Connect with your senses through taste, touch, sound, smell and sight. Draw on these senses to experience pleasure and deep fulfilment. Treat yourself to a day spa, learn massage, enjoy a fine restaurant or spend more time with your partner. Discover different approaches to expressing yourself creatively, be it through painting, music, drama or other art forms. This may be the perfect chance to take up a new hobby that enables you to access this part of yourself./n The Empress signifies abundance. You are surrounded by life’s pleasures and luxuries and have everything you need to live a comfortable lifestyle. You are in a period of growth, in which all you have dreamed of is now coming to fruition. When the Empress appears in your Tarot readings, take a moment to reflect on the bounty that surrounds you and offer gratitude for all you have created so you can continue to build on this energy and create even more abundance in your life./n As the Mother Earth archetype, the Empress urges you to venture out into nature to ground your energy and be in flow with the earth. Take a trip to your favourite natural setting, be it a forest, beach, mountain or lake, and sit for a couple of minutes, hours or even days to breathe in the energy that surrounds you while marvelling in the beauty of your surroundings. Allow yourself the time and the space to enter a different frame of mind and receive the grounding spirit of nature into your heart and consciousness. When you do this, you can reach higher planes of consciousness./n When you are in tune with the energy of the Empress, you will naturally take on her mothering nature. You feel a strong urge to nurture and care for others, from a place of loving compassion and support. You see it as a gift and an honour to tend to others, and in doing so you, too, receive benefit. In a more literal sense, you may step into the role of ‘mother’, perhaps as the mother of a newborn, caretaker of other people’s children, or spending more quality time with your kids./n The Empress can also suggest pregnancy or birth. This may be an actual pregnancy or childbirth, or a metaphorical ‘birth’ of a new idea or project. Bring your creative ideas into being by nurturing them and supporting their growth. Allow those designs and their manifestation to flow through you, acting with compassion and love.",
        reversed_meaning: "Reversed, the Empress encourages you to make self-love and self-care a priority. Now is the time to bring your loving energy and focus to yourself, especially if you have been giving away your personal power by placing too much emphasis on another person’s emotional or material needs, thus neglecting your own. Book a girls’ weekend, go for a walk on your own or start a creative project that’s just for you. It is essential that you fill your cup and care for yourself so you can then take care of others without resentment./n You may also crave a stronger connection with nature and Mother Earth. Now is the perfect occasion to spend even just a few hours in a natural setting such as a beach, park or garden. Breathe in the radiant energy as you’re surrounded by nature’s beauty and take time to notice the little things: an ant racing along on the ground, new leaves budding on the trees, or the rich purples and greens of the flowers and plants./n The Empress reversed can suggest that you are feeling a creative block, especially in ‘birthing’ a new idea or expressing yourself creatively. You may worry whether it will be a success or if your work is appealing to others. For now, don’t bother about what others think. The important thing is that you are allowing your creative energy to flow, even if it means keeping your newest creations private to you only (and even if they look like a three-year-old created them!)./n The reversed Empress may call your attention to issues around body image. Are you your biggest critic when it comes to how you look and the shape of your body? Learn to love your body again and give thanks for the lovely curves, lumps and bumps. Rediscover your beauty, inside and out./n In your relationships, you may take the ‘mothering’ role too far, becoming overprotective, co-dependent and controlling. If this resonates, it is time to shift your focus from the mother-child relationship to an adult-to-adult relationship by creating independence, trust and loving compassion.",
        keywords: ["Abundant creativity", "Fertility", "Fulfillment", "Mother figure", "Productivity"],
        reversed_keywords: ["Creative block", "Dependence on others", "Stagnation"],
        upright_questions: ["What seeds have you sown that are now ready to be harvested?", "What successes are you ready to celebrate?", "Where are you able to be especially generous and loving?"],
        reversed_questions: ["Where are you being a little too lazy or self-indulgent?", "Where are you being too selfish?", "What seeds have you sown that ended up not bearing fruit and how might you start over?"],
        ...
        yes_no: "The Empress stands for all things motherly. A nurturing, loving problem solver, she indicates successful business ventures or other positive, productive opportunities to come. She suggests moving forward to fulfill your full potential, and the answer you seek is yes.",
        numerology: "3",
        element: { element: "Earth", description: "The element earth represents the physical world and all that is tangible. It is a very grounding and stable energy, and is associated with the five senses. This element is healing, but allows you to grow and change"},
        astrological_associations: "Venus"
    },
    {
        card_name: "The Emperor",
        arcana: "Major Arcana",
        suit: "Trump",
        img: "../images/cards/m04.jpg",
        companion_cards: ["Death"],
        meaning: "As the father figure of the Tarot deck, the Emperor suggests that you are adopting this fatherly role (regardless of whether you are male or female), providing for your family, and protecting and defending your loved ones. You may be the breadwinner or the ‘rock’ for those who rely on your stability and security./n Similarly, the Emperor represents a powerful leader who demands respect and authority. Status, power and recognition are essential to you, and you are most comfortable in a leadership role where you can command and direct others. As a leader, you rule with a firm but fair hand. You have a clear vision of what you want to create, and you organise those around you to manifest your goal. You listen to the advice of others, but you prefer to have the final say. Conflict doesn’t scare you, and you won’t hesitate to use your power to protect those you care about. And in return, those people will repay you with the loyalty and respect you deserve. Claim your authority as leader and influencer and don’t let others put you down./n The Emperor reflects a system bound by rules and regulations. You create law and order by applying principles or guidelines to a specific situation. Create calm out of chaos by breaking down any problem into its parts and then mapping out the actions you need to take to resolve it. Be systematic, strategic and highly organised in your approach, and stick to your plan until the end./n The Emperor card also signifies world knowledge and expertise. Through the course of your life, you have gained valuable wisdom and life experience, and now you enjoy offering guidance, advice, and direction to someone who might benefit from it. You may be a teacher, coach, boss, or just a good friend who likes to take what you have learned and pass it on so that others can be as wise and powerful as you.",
        reversed_meaning: "The reversed Emperor calls on you to assess your relationship with power, control, authority, responsibility and discipline. Are you expressing too much or too little of these elements in your life right now? Are they working for you or against you?/n In the reversed position, the Emperor can be domineering and rigid in his thinking. The card can suggest an over-use and abuse of authoritative power surrounding you. It could originate from you or from another person, often a boss, partner or father figure. And it may be because of deep insecurities or father issues from childhood./n Consider the role that power plays in your life. Are you asserting your power and dominance in a way that leaves others feeling powerless? Or are you giving away your personal power to please someone else, often a father-figure or a person in authority? Seek to find a solution where you lead from a place of personal power and enable others to do the same. Power can be equally and constructively distributed – you don’t need to take it from others, nor do you need to give yours away./n The reversed Emperor may be a sign that others look to you as their leader or as an expert in the field but you are shying away from the role. You may fear being seen as the leader, instead preferring to hide in the shadows or stay out of the spotlight. There may be other ways you can make an impact and influence the world, such as authoring a book or training others to reach a bigger audience./n Sometimes, the reversed Emperor asks you to stand up to authority. You may feel fed up with an overbearing boss or a hierarchical organisation and feel compelled to enter a more flexible and adaptive environment. Maybe you aspire to be your own boss and work independently by starting up your own business. Or, you may seek a career where you can have greater flexibility and creativity in how you complete your work. You are sick of having to always work within the confines of a particular structure or way of doing things, and you want to break free from it./n When the reversed Emperor pops up in a Tarot reading, pay attention to your commitment to your goals and your self-discipline to get the job done. If you are struggling to see any real outcomes, check that you have a plan in place, a routine to support it, and the dedication to see it through. You may need to get a little tough on yourself and do the uncomfortable work you’d prefer to avoid. But if you can harness the positive, upright energy of the Emperor, your efforts will lead to success./n In a relationship reading, the reversed Emperor suggests that you may be in an unequal partnership and it‘s making you unhappy in the long term. Your significant other has become overbearing, possessive, dominating and authoritative. While you may have been looking for a partner to take care of you and offer a stable foundation for the future, those qualities have gone too far, and it seems as though much of your independence and freedom have been taken away. This dynamic is putting a strain on the relationship and preventing a flow of energies between you.",
        ...
        upright_questions: ["What skills have you mastered?", "Where in your life are you wielding power and authority wisely?", "What do you do to bless other people?"],
        reversed_questions: ["Where is power and/or authority thwarting or blocking you?", "Where are you too controlling or rigid?", "Are you willing to step aside and let others learn and try?"],
        ...
        yes_no: "The Emperor, as the counterpart to the Empress, stands for all things fatherly. He is structure, order, and authority in your life. While moving forward in your endeavors, this card indicates that assertiveness and rationality will take you a long way. With that, your answer is yes.",
        numerology: "4",
        element: { element: "Fire", description: "The fire element rules creation and inner spirit. This element responds to how it is handled. When in control, you can use fire as a positive tool; lose that control and it can be destructive and painful."},
    ...
    },
    {
        ...
        upright_questions: ["What is your relationship to spiritual leaders and/or religious authorities?", "Where in your life do find spiritual succor and sanctuary?", "What is the role of charity in your life – both giving and receiving?"],
        reversed_questions: ["Where is there too much dogma?", "What spiritual beliefs and traditions might be creating a challenge for you at this time?", "Are you ignoring the messages you are receiving from the Spirit World?"],
    ...
    },
    {
        ...
        upright_questions: ["Where is the harmony and unity in this situation?", "How can two apparent opposites (people, forces, circumstances, etc) come together in a creative way?", "Where is the love and commitment in this situation?"],
        reversed_questions: ["Where is harmony and unity being blocked or thwarted?", "What role does anger and hate play in the situation?", "What is the temptation to be aware of?"],
        ...
        yes_no: "The Lovers suggest being at a crossroads somewhere in your life. While this card is highly symbolic of relationships, love, and togetherness, it could also be revealing a positive business partnership or teaming up to move forward in your life. The answer to your question is yes.",
        numerology: "6",
        element: { element: "Air", description: "The Air element rules over the intellect and the balancing and opposing nature of thoughts. It is a fast-moving energy that seems invisible, but is always there. This element forces you to look at different perspectives and deal with the challenges in your life."},
    ...
    },
    {
        ...
        arcana: "Major Arcana",
        suit: "Trump",
        img: "../images/cards/m07.jpg",
        companion_cards: ["The Tower"],
        meaning: "The Chariot is a card of willpower, determination and strength. You have discovered how to make decisions in alignment with your values with the Lovers card, and now you are taking action on those decisions. When the Chariot appears in a Tarot reading, take it as a sign of encouragement. You have set your objectives and are now channelling your inner power with a fierce dedication to bring them to fruition. When you apply discipline, commitment and willpower to achieve your goals, you will succeed./n Now isn’t the time to be passive in the hope that things will work out in your favour. Take focused action and stick to the course, no matter what challenges may come your way – because, believe me, there will be challenges. You may be pulled in opposite directions and find your strength and conviction tested. Others may try to block you, distract you, or drag down the pursuit of your goal. But the Chariot is an invitation to draw upon your willpower and home in on what’s essential to you, so you can push past the obstacles in your way./n If you are curious about whether you have what it takes to achieve your aim or complete an important project, the Chariot is a sign you will be successful so long as you keep your focus and remain confident in your abilities. You need to use your willpower and self-discipline to concentrate on the task at hand. You can’t cut corners or take the easy route, or you will fail. Instead, see this endeavour as a test of your strength and conviction, and recognise that victory is within reach, but it’s up to you to follow through./n The Chariot calls you to assert yourself and be courageous. Be bold in expressing your desires and laying down your boundaries; otherwise, you will not get your way. You need to have faith in yourself and know fundamentally who you are and what you stand for (thus building off the personal belief systems and values established through the Lovers card). /n In a very literal sense, the Chariot can represent travel, especially driving or taking a road trip. You may even be considering selling your home and buying an RV so you can head off and roam the country!",
        reversed_meaning: "Upright, the Chariot is a green light to move ahead with a key project and push past any obstacles that might impede your desired outcome. Reversed, however, the Chariot tells you to ‘back up the truck’ or, as we Aussies say, “Chuck a U-y” (AKA “do a U-turn”). You might bang your head against a brick wall, trying to push a project forward when really, you ought to back off or change direction. Or you might have lost your motivation and no longer feel as committed to the outcome as you did when you started. So, if something is not moving forward as you planned, re-evaluate the situation and check in to see if it’s a sign that you need to change course. Then ask yourself: Is there a deeper reason things have become more challenging? What lesson can I learn here?/n At times, the reversed Chariot is a warning that you are letting obstacles and challenges get in the way, preventing you from achieving what you set out to do. It’s all getting too hard, and you don’t have the will to go on. If that resonates, stop for a moment and think about the things that matter most to you and why you want to achieve this goal. Will you allow other people’s opinions to sway you or give up as soon as the going gets tough? Or will you follow through on your commitment?/n Before taking action, the reversed Chariot may be a hint that you are focusing your energy and attention on your internal processes, such as self-discipline, inner determination and personal commitment. You may home in on the intentions that align with your Higher Self. Or, you can use visualisation and meditation to make sure your energy aligns with your goals. These internally focused actions are essential so that when the time comes to act, you will be ready./n If you are someone who likes to have command over your destiny and know where you are heading, take this opportunity to tighten the reins and become more disciplined in what you are doing. While feeling a loss of power can be quite demoralising, the key is to look at what you can control and what you cannot. Do not allow yourself to worry about what is out of your grasp as you cannot change it now. Instead, focus your energies on what IS in your control. Examine what you can do to improve the situation./n Similarly, the Chariot reversed suggests that you may be trying to manage every minute detail in your life – but in doing so, you feel even more out of control. Loosen your grip and let things run their course. Be open to offers of help and then be grateful for what you receive, even if it’s not perfectly aligned with your expectations. You do not always have to be in the driver’s seat!",
        keywords: ["Journey", "Progression", "Strong character", "Success from effort", "Transportation and movement"],
        reversed_keywords: ["Lack of direction", "Opposition", "Self Doubt"],
        upright_questions: ["here is the movement in this situation?", "What is the alignment and cooperation in this situation?", "How do I transcend this challenge?"],
        reversed_questions: ["How can I best address the lack of cooperation?", "What elements need to be brought together in order to achieve victory?", "What is the tension in this situation creating paralysis?"],
        ...
        yes_no: "The Chariot reveals some sort of journey. With a positive connotation, this journey will most likely be a progression of some sort. It could also be the final success you have been working for. The confidence, direction, and victory shown through this card indicate that the answer is yes.",
        numerology: "7",
        element: { element: "Water", description: "The element of water represents emotions and relationships. It can be calm and gentle or forceful and dangerous. Like water, emotions ebb and flow and are influenced by their surroundings."},
        astrological_associations: "Cancer"
    },
    {
        card_name: "Strength",
        arcana: "Major Arcana",
        suit: "Trump",
        img: "../images/cards/m08.jpg",
        companion_cards: ["The Star"],
        meaning: "The Strength card represents strength, determination, and power – like the Chariot. However, while the Chariot signifies outer strength and will, the Strength card speaks to the inner strength and the human spirit's ability to overcome any obstacle. Strength is about knowing you can endure life’s obstacles. You have great stamina and persistence, balanced with underlying patience and inner calm. You are committed to what you need to do, and you go about it in a way that shows your composure and maturity./n When the Strength Tarot card appears in a reading, you are fuelled by your inner strength, personal power, strong will and determination. You do not rule by trying to control others; you quietly influence and persuade. Others may underestimate your power because it is so ‘invisible’ – but you should see that as an advantage. You can control a situation without excessive, outward force. No one knows it’s you calling the shots./n Your strength gives you the confidence to overcome any growing fears, challenges or doubts. Feel the fear and do it anyway! If you have been going through a rough time and are burnt out or stressed, the Strength card encourages you to find the power within yourself to persevere. You have got what it takes to see this situation through to its eventual end. You’re a loyal friend and a solid supporter, willing to step up and be present when others are in need, and you might also feel compelled to hold space for someone who needs your strength and support./n The Strength card urges you to ‘tame’ your animal instincts, gut reactions, and raw emotions, and channel these initial responses constructively. It’s normal for feelings such as anger, rage, sadness, guilt or shame to arise in certain situations. However, it’s what you do with these emotions that makes all the difference. Now is a time when you need to be conscious of your instinctual urges and bring them into balance with the greater good. This is no time to act out in rage or hatred. Approach your situation from a place of forgiveness, love and compassion. Working with a therapist may also help you create coping strategies for what comes up.",
        reversed_meaning: "When the reversed Strength card appears in a Tarot reading, tune in to your current levels of inner strength, confidence and self-belief. Are you overflowing with self-confidence, or are you depleted? And how can you bring these aspects back into balance?/n If you have recently experienced a setback, you may be vulnerable and lacking in self-confidence. Know that your core strength will always be with you and now is as good a time as any to reconnect with this power. In fact, you may hold more strength and resilience than you give yourself credit for – so, be kind to yourself. You can also reinvigorate your self-assurance and self-esteem by collecting evidence from your past that proves you have what it takes to succeed and overcome these temporary challenges./n Check in on your energy levels right now. You may be sluggish, particularly if you have been dedicating yourself to serving others or have been pushing hard to achieve a goal. The reversed Strength card is your invitation to take stock and restore your energy levels by resting and withdrawing for a temporary period. It’s vital that you take care of yourself so you can take care of others./n In its shadow form, the reversed Strength card can signal that you are prone to explosive behaviour, lashing out at others and becoming aggressive. You may act without thinking and end up doing something you regret later. The key is not to repress the raw emotion, but to learn how to channel it so it won’t harm others or yourself. Seek a professional to help you better deal with these emotions.",
        keywords: ["Energy", "Facing problems", "Strength", "Vitality", "Willpower"],
        reversed_keywords: ["Inner strength", "Self-doubt", "Low energy", "Raw emotion"],
        upright_questions: ["What would your life looks like if you operated with more strength?"],
        reversed_questions: ["Are you overflowing with self-confidence, or are you depleted? And how can you bring these aspects back into balance?"],
    ...
    },
    {
        ...
        upright_questions: ["How do you feel about consulting yourself on major issues? Or do you always rely on the advice and opinions of others?"],
        reversed_questions: ["Are you becoming a literal hermit and cutting yourself off from others?"],
    ...
    },
    {
        ...
        yes_no: "The Wheel of Fortune stands for luck, changes, and a new direction in your life. While it also shows ups and downs, the overall feel of the card is a positive one indicating changes for the better and good fortune. The answer you are looking for is yes.",
        numerology: "10",
        element: { element: "Fire", description: "The fire element rules creation and inner spirit. This element responds to how it is handled. When in control, you can use fire as a positive tool; lose that control and it can be destructive and painful."},
        astrological_associations: "Jupiter"
    },
    {
        card_name: "Justice",
        arcana: "Major Arcana",
        suit: "Trump",
        img: "../images/cards/m11.jpg",
        companion_cards: ["The High Priestess", "Judgement"],
        meaning: "The Justice card represents justice, fairness, truth and the law. You are being called to account for your actions and will be judged accordingly. If you have acted in alignment with your Higher Self and for the greater good of others, you have nothing to worry about. However, if you haven’t, you will be called out and made to own up to your actions. If this has you shaking in your boots, know that the Justice card isn’t as black and white as you may think. A level of compassion and understanding accompany Justice, and although you may have done something you regret, this card suggests that you will be treated fairly and without bias. Be ready to take responsibility for your actions and stand accountable for the ensuing consequences./n If you seek justice, then the Justice card is a positive sign that it will indeed be served. You may be part of a legal case or awaiting final judgement from the courts or a governing body or institution. A ruling will be passed down shortly. Once the decision is made, you must accept it and move on; there are no retrials or second chances with the upright Justice card./n The Justice card often appears when you need to make an important choice with the potential for long-term repercussions. Be aware of the impact your decisions will have on your well-being and the well-being of others. Choose consciously by connecting with your inner guidance system (your intuition) and asking for the answer that is most in alignment with the highest good of all. Be ready to stand by your decisions as you will be held to account for the choices you make. You need to ask yourself, “Do I stand by my decisions and accept the consequences of my actions?” If you cannot, then dig deeper, plunging into the shadows of what is right and wrong, until you find the place where you can stand in integrity and strength./n At its core, Justice is about the search for truth. As you explore your truth, you will discover that things are not as clear-cut as you had thought. Be prepared to dip into the murky waters and explore what truth means to you. Be consciously aware of what you believe to be true and what you believe to be fair and ethical. It may not be as clear-cut as you think, so prepare to challenge yourself and to explore new territories of your belief system.",
        reversed_meaning: "The reversed Justice card can suggest that internally, you know you’ve done something that isn’t morally right. Others may not see it yet, so you have a choice: you can hide it and hope no-one finds out, or you can own up to your mistakes and take focused action to resolve the situation. Whichever you choose, you will need to live with the consequences on your conscience, so go with what feels right for you./n Similarly, Justice reversed suggests that you are not willing to take full accountability for your actions and may try to ‘dodge the bullet’ and blame others for your mistakes. You are being dishonest with yourself and others – and your unwillingness to look beyond your own fears and ego blinds you to the broader lesson. Assess your situation once more, this time intending to discover where you can accept responsibility. Once you acknowledge where you made a mistake, do whatever you can to make it right again. In doing so, you will free yourself from any guilt or shame and empower yourself to make better decisions./n The reversed Justice card can indicate your inner critic is in full effect. You may be evaluating your every move and coming down hard on yourself when you misstep. If this resonates, start from a place of forgiveness and self-acceptance. Show yourself a bit of kindness and compassion, knowing we all make mistakes. Thank your inner critic for bringing this private judgement to your conscious awareness, and trust you can now clear it away./n If you are making an important decision that will impact others, be aware if you are holding on to any prejudice or bias that could sway your decision unfairly. You may need to source more information to make a balanced decision or shine the light on your own personal judgements./n If you are engaged in a legal matter, you may fear an unfair outcome, or dispute the final judgement, calling into question the legal process. There may be legal complications or something that impedes justice being served.",
        ...
        upright_questions: ["Do I stand by my decisions and accept the consequences of my actions?", "What does it mean to be operating out of integrity?"],
        reversed_questions: ["Have you ever experienced a situation where you had trouble making a moral decision? What did that feel like?", "When have you been unjust or the victim of injustice?"],
    ...
    },
    {
        ...
        upright_questions: ["How can I change my perspective?", "How can I surrender the need to control the current situation?", "What is my truth?"],
        reversed_questions: ["What idea, belief, person, or thing am I grasping too tightly?", "Is there anything else I can do right now? Or do I need to let it be?", "What would it take to make peace with myself and in my own mind right now?"],
        ...
        yes_no: "The Hanged Man suggests some sort of metamorphosis through breaking patterns, letting go, or going through a period of transition. Although it could indicate having to give something up in order to gain a fresh perspective, it has neither positive or negative connotations. Maybe is the answer.",
        numerology: "12",
        element: { element: "Water", description: "The element of water represents emotions and relationships. It can be calm and gentle or forceful and dangerous. Like water, emotions ebb and flow and are influenced by their surroundings."},
        astrological_associations: "Neptune"
    },
    {
        card_name: "Death",
        arcana: "Major Arcana",
        suit: "Trump",
        img: "../images/cards/m13.jpg",
        companion_cards: ["The Emperor"],
        meaning: "The Death card is probably the most feared and misunderstood of all the cards in the Tarot deck. Just mention the card’s name and most people freak out, worried they will suddenly keel over and die as soon as this card appears. Relax! The Death card can be one of the most positive cards in the deck./n After a period of pause and reflection with the Hanged Man, the Death card symbolises the end of a major phase or aspect of your life that you realise is no longer serving you, opening up the possibility of something far more valuable and essential. You must close one door to open another. You need to put the past behind you and part ways, ready to embrace new opportunities and possibilities. It may be difficult to let go of the past, but you will soon see its importance and the promise of renewal and transformation. If you resist these necessary endings, you may experience pain, both emotionally and physically, but if you exercise your imagination and visualise a new possibility, you allow more constructive patterns to emerge./n Similarly, Death shows a time of significant transformation, change and transition. You need to transform yourself and clear away the old to bring in the new. Any change should be welcomed as a positive, cleansing, transformational force in your life. The death and clearing away of limiting factors can open the door to a broader, more satisfying experience of life./n The Death card has elements of a sudden and unexpected change. Death happens to everyone, no matter who you are, how much money you have, where you live, or what colour your skin is; it is the same with a significant change. So, the Death card can be a sign you may feel as though you are caught in the path of sweeping change and cannot escape its effects (especially if accompanied by the Tower or the Hanged Man). Although the upheaval may seem unwanted and painful, this massive change could bring with it a series of unexpected surprises that create new opportunities and advantages for you./n Finally, Death is a sign that you need to learn to let go of unhealthy attachments in your life to pave the way to a fuller, more fulfilled life of deeper meaning and significance. Death teaches you to let go of outworn and outgrown ways of life and to move forward from them. This is a perfect card to break a bad habit or pattern of behaviour. See this as a time to cut out excess and let go of what is unnecessary for your life. Purge the old belongings, memories and baggage that are getting in your way.",
        reversed_meaning: "Upright, Death is a card of transformation and typically refers to needing to start over by letting go of the past. In the reversed position, Death can mean that you are on the verge of meaningful change but are resisting it. You may be reluctant to let go, or you may not know how to make the change you need. You still carry harmful viewpoints from the past that may interfere with a new opportunity. Because of your refusal, life has stagnated, and you feel stuck in limbo./n Death reversed offers you the opportunity to embrace change rather than resist it. See what wonderful possibilities become available to you as you say ‘yes’ to change. As you learn to release the past and surrender to the present, the future becomes even brighter. To support the process, repeat this affirmation: “I embrace change in all forms.” You’ll be surprised at how this subtle shift in energy allows new doors to open in ways you may never have expected./n On a deeper level, the reversed Death card can show that you are going through a massive personal transformation, often in private and out of view from others. You are releasing what no longer serves you so that you can make space for the new to emerge. Draw a follow-up card to understand better what you need to release and purge, or examine the other cards in the reading. You may be removing fear and limiting beliefs; you may be changing your habits; or, you may undergo a physical purging and transformation with plant medicine or other spiritual healing. You may not want to share this with others just yet – wait until your personal transformation has occurred, then share your story as a source of inspiration.",
        keywords: ["Endings", "Change", "Transformation", "Transition"],
        reversed_keywords: ["Resistance to change", "Personal transformation", "Inner purging"],
        upright_questions: ["What should I let go of?", "Are there aspects of my ego that are preventing growth?"],
        reversed_questions: ["What am I afraid of?", "What do I need to grieve?"],
        ...
        yes_no: "The Death card shows some sort of dramatic change in order to have a new beginning. It is often associated with some sort of loss, failure, or destruction. The overall tone of this card is dark and not good. Thus, your answer is no.",
        numerology: "13",
        element: { element: "Water", description: "The element of water represents emotions and relationships. It can be calm and gentle or forceful and dangerous. Like water, emotions ebb and flow and are influenced by their surroundings."},
        astrological_associations: "Scorpio"
    },
    {
        card_name: "Temperance",
        arcana: "Major Arcana",
        suit: "Trump",
        img: "../images/cards/m14.jpg",
        companion_cards: ["The Hierophant"],
        meaning: "Temperance is the card for bringing balance, patience and moderation into your life. You are being invited to stabilise your energy and to allow the life force to flow through you without force or resistance. It’s time to recover your flow and get your life back into order and balance./n This card calls on you to remain calm, even when life feels stressful or frantic. Maintain an even temperament and manage your emotions. You have learned to keep composed in stressful situations. Little things don’t get to you, thanks to your seemingly abundant source of patience. Your respect for balance and tranquillity is what will help you achieve and experience fulfilment in your life./n Temperance asks you to take the middle path and accommodate all perspectives. Now is not the time to be highly opinionated or controversial. Be the peacekeeper and take a balanced and moderate approach, avoiding any extremes. Include others and bring together diverse groups of people to create harmony and cooperation. By working together, you will collectively leverage the right mix of talents, experiences, abilities and skills./n There is alchemy within Temperance. This Tarot card is about blending, mixing, and combining diverse elements in a way that creates something new and even more valuable than its separate parts. ‘Blending’ can take on many forms; for example, a blended family, an artist who blends different materials or techniques, a bartender who mixes new and exciting cocktails, or a chef who combines different cuisines and cooking styles./n The Temperance card shows that you have a clear, long-term vision of what you want to achieve. You are not rushing things along; instead, you are taking your time to ensure that you do the best job you can. You know you need a moderate, guided approach to reach your goals./n Finally, this card reflects higher learning. You are learning a great deal where you are now and are at peace with what you are doing – it is all coming together well. Your inner voice is guiding you to the right outcome, and you are patiently listening and following.",
        reversed_meaning: "If you have recently experienced a period of excess, the reversed Temperance card is your invitation (or sometimes, your warning signal) to restore balance and moderation as soon as possible. You may have been over-eating, regularly drinking, buying things you can’t afford, arguing with loved ones, or engaging in negative thought patterns. These activities are taking you further away from who you are and what you are here to do. So, it is time to stop. As they say, “Everything in moderation!” Or, you may find you need 100% abstinence to break this negative cycle and bring your life back into balance again./n The reversed Temperance card can also be a sign you sense that something is ‘off’ in your life, creating stress and tension. Life is not flowing as easily as you had hoped or there’s a niggling voice from within going, “Wait a second! This doesn’t feel right!” You can ignore it and carry on with life as usual. But, heed Temperance’s warning: If you stay in this state for too long, that voice will just get louder and louder until you pay attention. Or, you can listen to it now and make the necessary adjustments to find your flow once again. Focus on your long-term vision and higher purpose and seek to align your daily activities with this vision./n Temperance reversed may reflect a period of self-evaluation in which you can re-examine your life priorities. Internally, you may feel called in one direction, but your daily life may not match up to what is emerging. See this as your opportunity to align your higher vibration with your outer world. You may need to change your living arrangements, relationships, career, and daily habits so you can cultivate more balance and purpose in line with your new priorities. Don’t be surprised if you run into tension or even conflict as you align your inner and outer worlds; it’s a natural part of the process of levelling up and creating positive change./n Similarly, the reversed Temperance card can be a call for profound self-healing. By creating more balance and moderation in your life, you open the possibility for such healing to occur. Given the reversal of this card, you are doing it in a way that is personal and private to you, without the influence of others. You know you have what you need to heal yourself and create more ‘flow’ in your life.",
        keywords: ["Capable", "Control", "Harmony and balance", "Moderation", "Self-confidence"],
        reversed_keywords: ["Imbalance", "Excess", "Self-healing", "Re-alignment"],
        upright_questions: ["How can I avoid extremes?", "In what way do you bring calm – or drama – to your life?", "How do you make decisions?"],
        reversed_questions: ["What aspect of my life is lacking balance or moderation?", "What problem or issue should I take a look at from a new perspective?"],
        ...
        yes_no: "The Temperance card suggests divine intervention, balance, and harmony. The positive overall presence of this card in your spread reveals high levels of self-confidence and control in your endeavors. The answer provided by this card is most likely yes.",
        numerology: "14",
        element: { element: "Fire", description: "The fire element rules creation and inner spirit. This element responds to how it is handled. When in control, you can use fire as a positive tool; lose that control and it can be destructive and painful."},
    ...
    },
    {
        ...
        upright_questions: ["When do you feel stuck?", "What negative things do you allow to remain in your life?"],
        reversed_questions: ["Where do you need to let go?"],
    ...
    },
    {
        ...
        upright_questions: ["Where is a drastic change needed?", "What needs to go?", "How do you handle changes that other people initiate?"],
        reversed_questions: ["What might it feel like to completely surrender to uncertainty?", "The sky is not falling – why are you fearing the worst?"],
    ...
    },
    {
        ...
        yes_no: "The Star is symbolic of hope, renewal, and beauty. It suggests a period of spiritual tranquility, happiness, and positive opportunities. The overall feeling of this card is optimistic and serene. The answer suggested by its presence is yes.",
        numerology: "17",
        element: { element: "Air", description: "The Air element rules over the intellect and the balancing and opposing nature of thoughts. It is a fast-moving energy that seems invisible, but is always there. This element forces you to look at different perspectives and deal with the challenges in your life."},
    ...
    },
    {
        ...
        yes_no: "The Two of Cups shouts about love, positive relationships, and togetherness. It suggests a life full of close bonds, good friendships, and mutual love and respect therein. This card encompasses all happy, positive, loving feelings. The answer it is providing to you is yes.",
        numerology: "2",
        element: { element: "Water", description: "The element of water represents emotions and relationships. It can be calm and gentle or forceful and dangerous. Like water, emotions ebb and flow and are influenced by their surroundings."},
        astrological_associations: "Cancer"
    },
    {
        ...
        yes_no: "The Three of Cups brings with it an abundance of love and joy. It suggests happy gatherings or celebrations and success in various aspects of your life. It is associated with loving celebrations and close relationships, and it means that the answer you seek is yes.",
        numerology: "3",
        element: { element: "Water", description: "The element of water represents emotions and relationships. It can be calm and gentle or forceful and dangerous. Like water, emotions ebb and flow and are influenced by their surroundings."},
        astrological_associations: "Cancer"
    },
    ...
    },
    {
        ...
        yes_no: "The Five of Cups is a regretful card full of sadness, loss, and despondency. It could be a sign of not appreciating what you have in life or possibly avoidance of something yet to come. The disappointment and discontent associated with this card provide an answer of no to your question.",
        numerology: "5",
        element: { element: "Water", description: "The element of water represents emotions and relationships. It can be calm and gentle or forceful and dangerous. Like water, emotions ebb and flow and are influenced by their surroundings."},
        astrological_associations: "Scorpio"
    },
    {
        ...
        arcana: "Minor Arcana",
        suit: "Cups",
        img: "../images/cards/c06.jpg",
        companion_cards: [],
        meaning: "The Six of Cups is a card that takes you back to the happy memories from your past, whether as a child, teenager or young adult. You may simply be revisiting those memories in your mind, or you may travel back to your childhood home or reconnect with your childhood friends. You could go to a high school reunion or reconnect with an old buddy. A teenage sweetheart or past lover may turn up again. These connections bring you a sense of joy and happiness as you reminisce over all the fun times you had together. Take this occasion to explore whether you still have a lot in common and if you wish to continue the relationship now./n The Six of Cups often shows an increased level of harmony and cooperation in your relationships. You are ready to give and receive, without expectation. You are also willing to give each other the benefit of the doubt, having moved on from the challenging emotions of the Five of Cups. It’s time to turn over a new leaf and start afresh from a more positive place./n The Six of Cups invites you to get in touch with your inner child and experience the fun, freedom and innocence that comes with being a young child again. You might like to sit down with an adult colouring book, dance like no-one is watching you, play your favourite childhood games or spend more time around (happy) children. When you give yourself permission to be playful, spontaneous, and creative, you connect more with your authentic self and your intuition./n The Six of Cups can also refer to children in your life. It can suggest a pregnancy (perhaps twins), a birth and siblings who play nicely together. It may also be a sign that you are about to spend more time with young children, playing, laughing and learning together. Children are often here to teach you something about yourself and can serve as great advisors. Kids also set good examples for how to stay present, open-minded and curious. They see the world as a magical place and their hearts are open to the myriad of pleasures available to them.",
        reversed_meaning: "When the reversed Six of Cups appears in a reading, ask whether you're clinging to the past and losing touch with the present. Reflection and nostalgia may bring up positive or negative feelings, but either way, when you find yourself wishing for ‘how things used to be’ and not living in the present, you miss out on the opportunities right in front of you. It's OK to indulge a little in reminiscing about the past, as long as you understand that true and lasting change can only happen in the present moment. See the Six of Cups as an opportunity to make peace with the past so you can focus on the now. Learn from your mistakes, forgive others and yourself, and acknowledge that life is continually evolving. Let go of the past and bring your attention firmly into the present./n The reversed Six of Cups may also be a sign you have lost touch with your inner child and life has become boring, repetitive, and ‘stale’. You might be closed off from new opportunities and gifts from the Universe, simply because you are taking on too much of the responsibility and heaviness that come with 'adulting'. Open yourself to a curious mind and to have fun as though you were a child again. If you find yourself saying, “Oh but I don’t have time!” then make time!! Play! Have some time out. Go jump in puddles or build sand castles./n The Six of Cups reversed might be a sign that you are taking a private walk down memory lane. Perhaps you are thinking about an ex, or you’ve even started seeing each other again, but you want to keep this information quiet. You may be reluctant to let others know that you are revisiting these old memories or relationships, in fear that they may judge you.",
        ...
        upright_questions: ["What do you cherish about your past?", "What needs to be released?"],
        reversed_questions: ["How can you enjoy the present moment?", "Are you clinging to the past?"],
        ...
        yes_no: "The Six of Cups says something by the way of reconciliation and leaving the past behind. It could mean some sort of apology or returning to the past to unlock skeletons from the closet. There is a sense of relief and moving forward with its presence, and the answer you seek is likely yes.",
        numerology: "6",
        element: { element: "Water", description: "The element of water represents emotions and relationships. It can be calm and gentle or forceful and dangerous. Like water, emotions ebb and flow and are influenced by their surroundings."},
        astrological_associations: "Scorpio"
    },
    {
        ...
        upright_questions: ["What is your process before making a decision?", "Do you trust your gut…or need the facts?"],
        reversed_questions: ["What is your fantasy?", "And are you ready to take the steps necessary to turn your fantasy into a reality?"],
        ...
        yes_no: "The Seven of Cups symbolizes confusing decisions, wishful thinking, and temptation due to a lack of morality. Delusional ambitions and poor choices are associated with this card. It brings a definite feeling of pessimism and negativity. The answer is no.",
        numerology: "7",
        element: { element: "Water", description: "The element of water represents emotions and relationships. It can be calm and gentle or forceful and dangerous. Like water, emotions ebb and flow and are influenced by their surroundings."},
        astrological_associations: "Scorpio"
    },
    {
        ...
        yes_no: "The Eight of Cups shows some degree of change happening in your lifestyle. It brings feelings of despondency, indifference, and avoidance. It could indicate a need to give up, leave, or turn away from something in your current life. The melancholy feeling associated with this card suggests no.",
        numerology: "8",
        element: { element: "Water", description: "The element of water represents emotions and relationships. It can be calm and gentle or forceful and dangerous. Like water, emotions ebb and flow and are influenced by their surroundings."},
        astrological_associations: "Pisces"
    },
    {
        ...
        upright_questions: ["Can you be content with what you have?", "What blessings do you have trouble acknowledging?"],
        reversed_questions: ["When you think of indulging, what comes to mind?", "What is your deepest wish?"],
        ...
        yes_no: "The Nine of Cups shows feelings of joy, satisfaction, pleasure, and overall contentment. Its presence is indicative of a bright future brimming with good times, bliss, and a period of your wishes all being granted. The answer you are looking for is yes.",
        numerology: "9",
        element: { element: "Water", description: "The element of water represents emotions and relationships. It can be calm and gentle or forceful and dangerous. Like water, emotions ebb and flow and are influenced by their surroundings."},
        astrological_associations: "Pisces"
    },
    {
        ...
        yes_no: "The Ten of Cups represents perfect harmony, abundance, and happiness. It suggests perhaps personal or family dreams coming true and an overall sense of satisfaction and security in life. Positive achievements and emotional stability ahead of you, the answer you seek is yes.",
        numerology: "10",
        element: { element: "Water", description: "The element of water represents emotions and relationships. It can be calm and gentle or forceful and dangerous. Like water, emotions ebb and flow and are influenced by their surroundings."},
        astrological_associations: "Pisces"
    },
    {
        ...
        arcana: "Minor Arcana",
        suit: "Cups",
        img: "../images/cards/c11.jpg",
        companion_cards: [],
        meaning: "The Page of Cups suggests a new idea or opportunity has come to you out of the blue. Your creative energy is flowing, and now the question is how you will express it. Will you snap up this new idea and turn it into something, or will you let someone else bring it to fruition? It is up to you! Spend time exploring the idea to see if you want to move forward./n The Page of Cups invites you to have an open and curious mind. Be open to anything – including a fish popping its head out of a cup! It is with a curious mind that you will discover new aspects of life and yourself. Open your mind to all possibilities, especially those of a creative or intuitive nature, you will be pleasantly surprised. Be ready to dream the impossible dream, and explore the magic of your fullest potential, even if it seems out of reach. The Page of Cups is asking you to embrace your inner child and believe that anything is possible./n As each Page asks you to explore a new facet of yourself, the Page of Cups is asking you to explore your creative, emotional self. You may start a new art class, read books about how to express your feelings, or learn more about developing your psychic abilities. Dreamy aspirations race through your mind, and you may find yourself moved by simple things. Don’t be afraid to let your feelings show and wear your heart on your sleeve./n This card often appears when you are being called to trust your intuition and be open to the multitude of intuitive messages coming your way. Look for synchronicities and signs from nature that will guide you on your path. They may come from unexpected places, or they may not even make sense to your rational mind; be open to the possibility and ready to discover new aspects of yourself. It is like following ‘intuitive breadcrumbs’ – one intuitive clue leads you to the next thing, and the next, and the next. And before you know it, you have found yourself in a place of full alignment, happiness and bliss. All by trusting your intuition and going with the flow./n In a practical sense, the Page of Cups can indicate that you will receive an unexpected and pleasant surprise. The Pages are often known as the messenger cards, and with the Page of Cups, you may receive a message related to the emotions, intuition, or creative endeavours. It might be the birth of a baby, an engagement or marriage, a new love interest, or the offer of a new project. It is not a surprise you can anticipate or force; be ready to receive when the moment comes.",
        reversed_meaning: "The reversed Page of Cups suggests that you are keeping your creative inspirations and ideas secret. You may worry that others will steal your idea or tell you it’s destined to fail. Instead, you are choosing to keep your plans private so you can develop them further without the influence of others. You may want to wait until you’ve moved out of the conceptual stage before sharing it with others./n With the Page of Cups reversed, you may feel called to pursue a new creative project, but you doubt whether you can really make it work. Your inner critic may be on over-drive or others are telling you that you’re dreaming – so you are stalling and holding back. Ask yourself, “What have I got to lose here?” So what if the idea fails? Isn’t it better to try something and fail than never do it and wonder for the rest of your life what might have happened? And what if you didn’t fail? What if you were to succeed? Again, listen to your intuition to understand if fear is getting in the way and whether it’s time to just give it a go regardless of the outcome./n It is possible that you may experience a creative block when the reversed Page of Cups pops up in a reading. There is an aspect of your Self that wants to be expressed, but for whatever reason, you are holding back. You may worry whether your creativity will lead you in the direction you want, or whether it has value in this world. Or, you may feel ‘stuck’ when it comes time to express yourself creatively, and you don’t know how to bring this side of yourself out into the external environment. The ideas are there, but you are having trouble figuring out how to make them into reality./n If you are exploring your intuition, the reversed Page of Cups can suggest that you are encountering a lot of doubt. You are trying hard to listen to your intuition, but when the messages come through, you are left wondering if it’s your inner guidance or your ego. Open yourself to your intuition and see where it takes you./n At times, the reversed Page of Cups can show someone who is emotionally immature – perhaps someone dramatic, who over-shares and takes their vulnerability a little too far. This may be someone who is prone to emotional tantrums when they do not get their way. Or it may be someone who is overly dreamy about their future and who is not grounded in reality. Some call it the 'Peter Pan Syndrome', in which an adult does not want to grow up and instead remains a child for the rest of their lives.",
        keywords: ["Creative opportunities", "Intuitive messages", "Curiosity", "Possibility"],
        reversed_keywords: ["New ideas", "Doubting intuition", "Creative blocks", "Emotional immaturity"],
        upright_questions: ["What would it look like if you expressed your emotions without holding back?", "How might you be more sympathetic to other people’s feelings?"],
        reversed_questions: ["What does your inner child need right now?", "Have you ever taken an emotional risk?"],
        ...
        yes_no: "The Page of Cups is a gentle, artistic, dreamer-type messenger. He brings with him announcements of good news and messages of new, serene beginnings. All dealings with this card are of a positive nature, and the answer it represents is yes.",
        numerology: "1",
        element: { element: "Water", description: "The element of water represents emotions and relationships. It can be calm and gentle or forceful and dangerous. Like water, emotions ebb and flow and are influenced by their surroundings."},
        astrological_associations: "Cancer"
    },
    ...
    },
    {
        ...
        yes_no: "The King of Cups is a compassionate, warm, and gentle voice of reason. He is an authoritative man with strong intuition and vast spiritual knowledge. This card represents being able to make decisions by channelling experiences and being able to give good/helpful advise. Neither positive nor negative in nature, the answer is unclear.",
        numerology: "2",
        element: { element: "Water", description: "The element of water represents emotions and relationships. It can be calm and gentle or forceful and dangerous. Like water, emotions ebb and flow and are influenced by their surroundings."},
        astrological_associations: "Libra, Scorpio"
    },
    {
        card_name: "Ace of Swords",
        arcana: "Minor Arcana",
        suit: "Swords",
        img: "../images/cards/s01.jpg",
        companion_cards: [],
        meaning: "The Ace of Swords marks a wave of new energy from the intellectual realms. You may be on the verge of a significant breakthrough or a new way of thinking that allows you to view the world with clear eyes. Or, you may have a sudden realisation or conscious understanding about an issue that has been troubling you and can finally see the path ahead of you. Meditate regularly to clear away the mental chatter and make the most of this intellectual potential./n See this card as a sign of encouragement. It says your mind is in 'expansion mode’. You are open to embracing new ideas, craving stimulation, and you’ll jump at the next opportunity to learn something new. You thrive on new ideas, inspiration, original thinking and vision, and you are excited to pursue new opportunities that draw upon your creative and intellectual abilities./n When the Ace of Swords appears in a Tarot reading, it tells you that now is an excellent time to start a new project – one that requires your intellect, communication skills and mental power. You may feel inspired to take a writing class, practice your public speaking skills, or get involved in activities that require more brainpower than usual./n How might you draw on this Ace's motivation and take action on your new ideas? As an Ace, you are at the beginning of the journey, but you can sense the energy building up and can’t wait to get started. If you channel this energy into the right moves, then you will succeed in your endeavours. Just remember that the road ahead may be bumpy and you can expect challenges along the way. Maintain a success mindset, and you will navigate these hurdles with ease./n As with all Swords cards, the Ace of Swords represents power; but the sword is a double-edged blade, implying that it can create and destroy. The message is clear: with power comes responsibility. It will be up to you how you leverage the opportunity for the greater good of all rather than for selfish or aggressive power. You will need a strong heart and mind and need to see how to best use your power for the service of others and yourself./n The Ace of Swords also encourages you to pursue the truth of the matter and to find justice. You may champion a cause or stand up for your rights or the rights of others. Or, you may have a new idea for which you are prepared to fight, or you may feel fired up about an issue you are passionate about, such as human rights. You have great clarity on the situation and can now argue your point of view with truth and conviction. In other words, you are ready for battle.",
        reversed_meaning: "The Ace of Swords reversed indicates that a new idea or breakthrough is emerging from within you, but you are not willing to share it with others just yet. You may still be exploring what this idea means for you and how to best express and manifest it in the external world. You may also seek greater clarity about whether this is an idea you wish to pursue more fully, perhaps because you are unsure if it will bring the results you truly desire. When this card appears in a Tarot reading, it’s important to give yourself time and space to meditate and clear your mind so you can ‘birth’ this idea in the most effective way./n Sometimes, the reversed Ace of Swords can be a signal you have an idea that’s not coming to fruition in the way you had hoped, and it’s time to go back to the drawing board. You may still be pursuing an idea that no longer has any meaning for you. Or you may have too many ideas on the go, and you cannot commit to one course of action. This card invites you to spend more time on defining in plain terms what it is you want in life. Set yourself some SMART goals (specific, measurable, achievable, realistic and time-bound) so you can be clear on what you are working towards. Focus on the basics and do some better planning. Get clear on your aspirations and goals./n The Ace of Swords reversed can also suggest clouded judgement and lack of mental clarity around a specific situation. You are missing relevant information or evidence that will help you decide, so invest your time and energy into seeking out the truth rather than just taking things at face value.",
        keywords: ["Breakthroughs", "New ideas", "Mental clarity", "Success"],
        reversed_keywords: ["Inner clarity", "Re-thinking an idea", "Clouded judgement"],
        upright_questions: ["What does it mean to be truthful?", "How does conflict make you feel?"],
        reversed_questions: ["Can you remember a time when you were forced to take initiative?"],
    ...
    },
    {
        ...
        companion_cards: [],
        meaning: "The Two of Swords indicates that you are facing a challenging decision, but you are unclear about which option to take. Both possibilities may seem equally good – or equally bad – and you are stumped about which will lead you to the best outcome. You must be able to weigh up the pros and cons of each choice and then make a conscious judgment. Use both your head (your mind and the intellect) and your heart (your feelings and intuition) to choose the path that is most in alignment with your Higher Self./n In a reading, it may be helpful to draw a further two cards for either side of the Two of Swords to show what it is you are trying to decide upon or balance. You may also like to draw four more cards, for the pros and cons of each choice./n The woman in this card wears a blindfold, indicating that she cannot see the entirety of her circumstance. You may lack the information you need to make the right decisions. You may be missing something, such as the threats or potential risks, alternative solutions or critical pieces of information that would help guide you in a particular direction. Once you remove the blindfold and see the situation for what it really is, you will be in a much better position to find your best path forward. Research your options more, seek outside opinions and feedback and ask yourself what you might be missing./n It is also possible that the woman in the Two of Swords has intentionally chosen to put on the blindfold to avoid making a choice. Are you trying to hide from a challenging situation or impending decision, hoping that if you ignore it long enough, you won’t need to worry about it? Unfortunately, the issue is unlikely to resolve itself, and the longer you delay, the longer you will prolong this present situation./n Similarly, the Two of Swords can reflect indecision and an impasse on an important matter. Again, you can only put it off so long; at some point, you have to make a move./n The Two of Swords comes as a reminder that many of life’s decisions are difficult ones and rarely come with clear-cut answers. The invitation is to make your choices with your best intentions, fully aware of the possible consequences. Avoidance will lead to greater conflict and stagnation.",
        reversed_meaning: "The Two of Swords reversed suggests that you are facing a difficult decision and cannot decide which direction to take. You are caught between a rock and a hard place, and it feels impossible to make the ‘right’ decision as you believe either option will lead to negative consequences. As a result, you are finding yourself feeling stuck and unable to move forward, which is just making the situation worse./n You may also lack the information you need to make a sound decision. Just as the blindfolded woman is closed off to the external world, you may also be closed off to additional information or alternative solutions that could resolve your dilemma. Or, you might be experiencing information overload, overwhelmed by other people’s points of view and a deluge of information. Sift through the advice available to select only the most relevant and helpful./n The reversed Two of Swords is inviting you to listen to your intuition about this difficult decision. You may need to cut off from the external world temporarily so you can hear your inner voice and allow your wisdom to come through. Trust what you know to be true and right for you. Make your decisions based on your own internal compass./n The Two of Swords reversed often represents a stalemate. You may reach an impasse with a friend, loved one, colleague or supplier. The trouble is that all parties involved are refusing to see the situation from the other's perspective and you are butting heads. Remove the blinders and look at the situation from a different angle. Identify where you can come to a compromise. Otherwise, this issue will not move forward./n The reversed Two of Swords may also suggest you are feeling stuck in the middle of two competing sides. You may be trying to play the peacemaker role, but in doing so, you are just confusing yourself and creating more tension. For example, you may attempt to bring two conflicting family members together in the hope of fostering a harmonious family environment, but instead, you end up being the messenger or the dumping ground for each of their concerns. Decide whether you honestly have a role to play and whether you can create peace between the two opposing parties. Otherwise, get yourself out of there!",
        keywords: ["Difficult decisions", "Weighing up options", "An impasse", "Avoidance"],
        reversed_keywords: ["Indecision", "Confusion", "Information overload", "Stalemate"],
        upright_questions: ["When do you feel the most centered?", "How can you see both sides of a situation without letting your emotions get in the way?"],
        reversed_questions: ["What viewpoints, other than my own, play a role in this situation?"],
        ...
        yes_no: "The Two of Swords symbolizes conflict resolution and decisions that must be made. However, the conclusions are likely through seeking inner peace and coming to a compromise. While this card suggests a general peace of mine, it leans neither toward yes or no. Thus maybe is the answer.",
        numerology: "2",
        element: { element: "Air", description: "The Air element rules over the intellect and the balancing and opposing nature of thoughts. It is a fast-moving energy that seems invisible, but is always there. This element forces you to look at different perspectives and deal with the challenges in your life."},
        astrological_associations: "Libra"
    },
    {
        ...
        yes_no: "The Three of Swords shows the presence of pain and suffering either through an emotional loss, the end of an important relationship, or heartbreak through separation. The emotional disturbances and mental anguish that come along with this card portray an answer of no to your question.",
        numerology: "3",
        element: { element: "Air", description: "The Air element rules over the intellect and the balancing and opposing nature of thoughts. It is a fast-moving energy that seems invisible, but is always there. This element forces you to look at different perspectives and deal with the challenges in your life."},
        astrological_associations: "Libra"
    },
    {
        ...
        arcana: "Minor Arcana",
        suit: "Swords",
        img: "../images/cards/s04.jpg",
        companion_cards: [],
        meaning: "The Four of Swords tells you to rest before you take on the next challenge. You have reached an important first milestone and must recharge your energy before the next phase begins so you are refreshed and ready to go. Even if you are highly productive and driven, take time out from your busy schedule to restore your energy and heal the body and the mind. Constant stress and tension will break even the hardest and most resilient of people but brief periods of rest enable you to refresh your energy, concentration and focus so that you are ready for the next challenge./n If you have been going through tough times recently, such as the trauma of break-up or departure, relationship or family problems, financial and health worries, stress or conflict, then the Four of Swords comes as a sign to take a step back and regain perspective. Take a day off work, travel to a new destination, or spend time with your loved ones – whatever you need to take a break. Now is not the time to make decisions./n In fact, the Four of Swords presents a new challenge: to stay silent and inactive. Now is the time to build up your mental strength by clearing your mind of any mental ‘clutter’ or stress. Meditate and spend time in a place that creates peace, calm and tranquillity for you. Go on retreat or start a meditation course. You need to replenish your strength and spend time connecting with your Higher Self./n The Four of Swords suggests the need for seclusion. You need solitude to negotiate your situation and time apart from others to gather your thoughts and feelings. Following on from the painful loss of the Three of Swords, this Four suggests your need to spend time alone to re-evaluate your life. Solitude, although often difficult to bear, is necessary for you to recharge your batteries and rejuvenate your spirit. This solitary experience always bears fruit in greater inner strength and confidence. Retreat from pain, conflict and distractions, and rid yourself of stress and anxiety. Ground and re-charge yourself. Look inward for a real change and meditate daily./n In a practical sense, the Four of Swords is an indicator that you need to take some time to review your progress so far. This is an excellent time to re-assess your priorities. It is almost like conducting your own ‘post-implementation review’ following a major milestone or a significant challenge. Create time and space to evaluate what has worked well, what has not, and what you need to change. Pausing to reflect after each major challenge will position you well for success in the future.",
        reversed_meaning: "The Four of Swords reversed sends a powerful message that you need to take time out to rest and recharge your energy. You may be working long hours, giving your time and energy to others in need, or involved in a highly stressful and demanding undertaking. You are close to exhaustion, and your energy reserves are running low or on empty. If you do not stop and take some much-needed rest now, you may crash and burn-out completely, rendering yourself completely ineffective and unable to help anyone./n The reversed Four of Swords is calling you to withdraw from your external world, and retreat within. Now is time for a social media detox, a weekend escape, or a silent retreat so that you can focus your energy within and find your peace once again. Use daily meditation to calm your mind./n The Four of Swords reversed can show that you are restless and wanting to do everything at once. Even if your body is telling you that you need to rest and relax, your mind may push you forward, trying to carry out a long list of tasks and making you sick or stressed as a result. So it is vital that you force yourself to take it easy to make sure you do not run yourself into the ground. Some ‘busy time’ is OK but be careful not to push it so far that you end up hurting your health and well-being. If you need to rest, rest. Even just a quick ‘nanna nap’ on the weekend or a twenty-minute meditation each day can help to re-balance your energy reserves and get you ready for even more productivity./n The Four of Swords reversed can also represent stagnation and a lack of action leading to increased frustration. For example, a long-term marriage has become spiritually and emotionally empty. You may need to take a break and come back to it when the energy is flowing better./n Similarly, the Four of Swords reversed suggests that you are frustrated with the lack of progress and change in your life. Part of this lack of change may be due to your passive approach. There may have been situations that were frustrating to you or that you were unhappy with but you chose to wait it out and hope that they would eventually change. Now you're feeling the ramifications of that choice.",
        keywords: ["Rest", "Relaxation", "Meditation", "Contemplation", "Recuperation"],
        reversed_keywords: ["Exhaustion", "Burn-out", "Deep contemplation", "Stagnation"],
        upright_questions: ["How do you incorporate rest in your world?", "What does self care look like in your life?"],
        reversed_questions: ["If you could take some time off, what would you do with that time?"],
        ...
        yes_no: "The Four of Swords points toward some sort of sickness or withdrawal. However, it also brings with it rest, healing, and order. Other interpretations could be simply taking a needed break or calling a truce. The position of this card is fairly mild but overall positive. The answer is most likely yes.",
        numerology: "4",
        element: { element: "Air", description: "The Air element rules over the intellect and the balancing and opposing nature of thoughts. It is a fast-moving energy that seems invisible, but is always there. This element forces you to look at different perspectives and deal with the challenges in your life."},
        astrological_associations: "Libra"
    },
    {
        ...
        reversed_questions: ["Do you need to be the winner every time?"],
        ...
        yes_no: "The Five of Swords suggests conflict, discord, and troubles to come. There could be a loss, defeat, or painful separation in the near future accompanied by feelings of brokenness and low self-esteem. Nothing associated with this card is of a positive nature, and thus, your answer is no.",
        numerology: "5",
        element: { element: "Air", description: "The Air element rules over the intellect and the balancing and opposing nature of thoughts. It is a fast-moving energy that seems invisible, but is always there. This element forces you to look at different perspectives and deal with the challenges in your life."},
        astrological_associations: "Aquarius"
    },
